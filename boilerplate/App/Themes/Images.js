...
const images = {
  ...
  cupido_circle_logo: require('../Images/cupido_circle_logo.png'),
  icon_default: require('../Images/icon_default.png'),
  close_button: require('../Images/close_button.png'),
  ignite_logo: require('../Images/ignite_logo.png'),
  base_icon: require('../Images/Icons/base_icon.png'),
